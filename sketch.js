...
function draw() {
  background("#e9edc9");  //有背景顏色，才不會有暫留
...
function gameover(){
  if (score>10){
    ...
    fill(255)  //填充的顏色
    textSize(50) //文字大小
    text("YOU WIN",width/2,height/2)  //顯示"YOU WIN"在網頁中間
  }else{
    fill("#E3D8E8")  //填充的顏色
    textSize(50) //文字大小
    text("加油",width/2,height/2)  //顯示"加油"在網頁中間
  }
}
